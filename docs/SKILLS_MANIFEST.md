...
- Skills directory: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills`
- Skill count: 72
- JSON manifest: `C:\Users\liuji\Desktop\scientific-research-skills\docs\skills-manifest.json`
...
| bayesian-intrinsic-growth-valuation | bayesian-intrinsic-growth-valuation | 1 | Use when the user wants Bayesian intrinsic-growth valuation for a company, including implied growth, 3-5 year growth probabilities, FOMO versus fundamentals, TAM, market share, margin trajectory, valuation multiples, industry cycle, or probability updates from new information. |
...
| gf-dma-health-index | gf-dma-health-index | 1 | Use when the user provides a ticker or asks for GF-DMA scoring, valuation/trend health, moving-average support, price-to-DMA divergence, ATR divergence, escape risk, estimate revisions, healthy momentum, or whether a rising/falling stock is fundamentally supported. |
...
| screenshot | screenshot | 1 | Use when the user explicitly asks for an OS-level desktop or system screenshot, such as full screen, a native app window, or a pixel region, and no tool-specific capture or app-testing capability is the better fit. |
| serenity-alpha | serenity-alpha | 1 | Use when the user wants Serenity-style alpha research that converts market-moving news, product launches, procurement signals, supply-chain changes, or earnings-call clues into investable hypotheses, small-cap beneficiaries, financial-statement transmission paths, validation metrics, downside risks, and position-sizing conditions. |
...
| tam-adj-peg | tam-adj-peg | 1 | Use when the user provides a ticker or asks for TAM-Adj-PEG valuation, growth-stock cheap/expensive judgment, TAM-supported runway, quality-adjusted PEG, or classification as core growth, high-beta growth, turnaround, option-like, or cyclical exposure. |
...
| webapp-testing | webapp-testing | 1 | Use when interacting with or testing local web applications using Playwright, especially localhost apps that need clicking through flows, capturing page screenshots, inspecting browser console errors, debugging UI behavior, or verifying frontend behavior. |
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\academic-research-suite\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\algorithmic-art\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\babysit\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\bayesian-intrinsic-growth-valuation\SKILL.md`
- Resource dirs: agents, references
- `bayesian-growth-valuation`: Use Bayesian intrinsic-growth valuation to judge whether this company's current market value already prices in its real 3-5 year growth, TAM, margins, and FOMO.

### brand-guidelines

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\brand-guidelines\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\buy-side-equity-research-memo\SKILL.md`
- Resource dirs: agents, references
- `buy-side-equity-memo`: Analyze NVDA as a source-backed buy-side memo with investment view, bull/base/bear target price scenarios, valuation, catalysts, risks, and monitoring dashboard.

### canvas-design

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\canvas-design\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\claude-api\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\do\SKILL.md`
- Resource dirs: none
- `execute-plan`: Execute the phased plan we already wrote and carry out the implementation steps.

### doc-coauthoring

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\doc-coauthoring\SKILL.md`
- Resource dirs: none
- `doc-coauthor-spec`: Co-author a technical spec with me, refine it iteratively, and make sure it works for readers.

### docx

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\docx\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\frontend-design\SKILL.md`
- Resource dirs: none
- `frontend-dashboard`: Build a polished React dashboard UI with filters, table view, chart panel, and responsive layout.

### gf-dma-health-index

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\gf-dma-health-index\SKILL.md`
- Resource dirs: agents, references
- `gf-dma-health-score`: Score this ticker with the GF-DMA Health Index using 20/50/100/200DMA trend, price-to-DMA divergence, ATR divergence, estimate revisions, and fundamental support.

### how-it-works

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\how-it-works\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\internal-comms\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\knowledge-agent\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\learn-codebase\SKILL.md`
- Resource dirs: none
- `learn-codebase-prime`: Learn this unfamiliar codebase by reading the source files and getting up to speed before changes.

### make-plan

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\make-plan\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\mama\SKILL.md`
- Resource dirs: none
- `mama-mode`: 妈妈模式，唠叨一点也行，盯着我把这个问题彻底解决。

### mcp-builder

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\mcp-builder\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\mem-search\SKILL.md`
- Resource dirs: none
- `memory-search-prior-solution`: Did we already solve this auth redirect issue before? Search memory for the earlier solution.

### nanobanana

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\nanobanana\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\openclaw\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\p10\SKILL.md`
- Resource dirs: none
- `cto-strategy`: Use CTO mode to define strategic direction, architecture governance, and org topology across teams.

### p7

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\p7\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\p9\SKILL.md`
- Resource dirs: none
- `subagent-tech-lead`: Act as P9 tech lead, split this project into task prompts, and coordinate multiple P8 agents.

### pathfinder

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pathfinder\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pdf\SKILL.md`
- Resource dirs: scripts
- `pdf-extract-merge`: Extract the tables from this PDF, rotate page 3, and merge it with another PDF.

### pptx

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pptx\SKILL.md`
- Resource dirs: scripts
- `slide-deck-edit`: Open this pptx deck, rewrite the speaker notes, and combine it with another presentation.

### pro

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pro\SKILL.md`
- Resource dirs: none
- `pua-pro-extensions`: Use PUA Pro extensions: KPI report, leaderboard, compaction-state protection, and self-evolution tracking.

### pua

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua\SKILL.md`
- Resource dirs: references
- `pua-main-mode`: 开启 PUA 模式，别再被动等指令，系统性排查、搜索源码、验证结论，把这个问题彻底解决。

### pua-cancel-loop

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-cancel-loop\SKILL.md`
- Resource dirs: none
- `pua-cancel-loop-alias`: Invoke the $pua-cancel-loop alias to cancel the current autonomous loop cleanly.

### pua-en

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-en\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-flavor\SKILL.md`
- Resource dirs: none
- `pua-flavor-alias`: Invoke $pua-flavor and show me the available PUA flavor options.

### pua-ja

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-ja\SKILL.md`
- Resource dirs: none
- `pua-ja-mode`: 日本語の詰め文化で pua-ja mode にして、同じ失敗を繰り返さず徹底的にデバッグして。

### pua-kpi

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-kpi\SKILL.md`
- Resource dirs: none
- `pua-kpi-alias`: Run $pua-kpi and generate the current PUA KPI report.

### pua-loop

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-loop\SKILL.md`
- Resource dirs: none
- `pua-loop-mode`: Start /pua:pua-loop 自动循环 and keep iterating until independent verification says the task is done.

### pua-mama

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-mama\SKILL.md`
- Resource dirs: none
- `pua-mama-alias`: Invoke $pua-mama as the alias form of mama mode.

### pua-off

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-off\SKILL.md`
- Resource dirs: none
- `pua-off-alias`: Run $pua-off to turn off PUA mode for this session.

### pua-offline

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-offline\SKILL.md`
- Resource dirs: none
- `pua-offline-alias`: Invoke $pua-offline so the PUA workflow runs without network access.

### pua-on

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-on\SKILL.md`
- Resource dirs: none
- `pua-on-alias`: Run $pua-on to enable PUA mode.

### pua-p10

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-p10\SKILL.md`
- Resource dirs: none
- `pua-p10-alias`: Invoke $pua-p10 for P10 CTO mode with PUA enforcement.

### pua-p7

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-p7\SKILL.md`
- Resource dirs: none
- `pua-p7-alias`: Invoke $pua-p7 for P7 senior engineer mode with PUA enforcement.

### pua-p9

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-p9\SKILL.md`
- Resource dirs: none
- `pua-p9-alias`: Invoke $pua-p9 for tech-lead task decomposition with PUA enforcement.

### pua-pro

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-pro\SKILL.md`
- Resource dirs: none
- `pua-pro-alias`: Invoke $pua-pro for the Pro alias command.

### pua-reap-orphans

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-reap-orphans\SKILL.md`
- Resource dirs: none
- `pua-reap-orphans-alias`: Run $pua-reap-orphans to clean up orphaned PUA agents or processes.

### pua-survey

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-survey\SKILL.md`
- Resource dirs: none
- `pua-survey-alias`: Invoke $pua-survey to inspect the current PUA environment and status.

### pua-team-status

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-team-status\SKILL.md`
- Resource dirs: none
- `pua-team-status-alias`: Run $pua-team-status to report all active PUA team agents and their state.

### pua-teardown-all

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-teardown-all\SKILL.md`
- Resource dirs: none
- `pua-teardown-all-alias`: Invoke $pua-teardown-all to stop and clean up all PUA agent activity.

### pua-yes

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\pua-yes\SKILL.md`
- Resource dirs: none
- `pua-yes-alias`: Invoke $pua-yes as the alias form for encouragement mode.

### research-idea-and-battle

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\research-idea-and-battle\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\scansci-pdf\SKILL.md`
- Resource dirs: none
- `paper-download-doi`: Download these DOI papers, get BibTeX citations, and save the PDFs for later reading.

### sci-figure

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\sci-figure\SKILL.md`
- Resource dirs: agents, references
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\screenshot\SKILL.md`
- Resource dirs: agents, assets, scripts
- `desktop-screenshot-capture`: Take a screenshot of my desktop and save it as a PNG file.

### serenity-alpha

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\serenity-alpha\SKILL.md`
- Resource dirs: agents, references
- `serenity-alpha-news`: Turn this supply-chain news into Serenity-style alpha: identify small-cap beneficiaries, financial-statement transmission, validation metrics, downside risks, and position-sizing conditions.

### shared-skill-installer

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\shared-skill-installer\SKILL.md`
- Resource dirs: scripts
- `shared-skill-install-download`: Download an AI skill from GitHub or OpenAI curated skills into my shared Skills library, stage it in the inbox, standardize it into library/skills, then connect it to Claude Code, Codex, and generic agents.

### shot

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\shot\SKILL.md`
- Resource dirs: none
- `pua-shot-mode`: Use /pua:shot, the concentrated single-file strongest PUA injection for a sub-agent.

### skill-creator

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\skill-creator\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\slack-gif-creator\SKILL.md`
- Resource dirs: core
- `slack-gif`: Make a Slack emoji GIF that loops cleanly, stays small enough to upload, and uses the right frame rate.

### smart-explore

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\smart-explore\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\tam-adj-peg\SKILL.md`
- Resource dirs: agents, references
- `tam-adjusted-peg`: Use TAM-Adj-PEG to decide whether this growth stock is cheap or expensive after adjusting for TAM runway, quality, margins, and growth durability.

### theme-factory

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\theme-factory\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\timeline-report\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\version-bump\SKILL.md`
- Resource dirs: scripts
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\web-access-main\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\webapp-testing\SKILL.md`
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\web-artifacts-builder\SKILL.md`
- Resource dirs: scripts
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\wowerpoint\SKILL.md`
- Resource dirs: none
- `wowerpoint-deck`: Wowerpoint this report into a cute NotebookLM-style slide-deck PDF.

### xgboost-lightgbm

- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\xgboost-lightgbm\SKILL.md`
- Resource dirs: none
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\xlsx\SKILL.md`
- Resource dirs: scripts
...
- `SKILL.md`: `C:\Users\liuji\Desktop\scientific-research-skills\library\skills\yes\SKILL.md`
- Resource dirs: none
